...
class Googlecalendar extends App_Model
{
    ...
    public function __construct()
    {
        ...
        $this->unauthorized_url_settings = '<h3>Seems that something is wrong, please check that your Client Secret is correctly inserted in <a href="'.admin_url(
                        'settings?group=appointly-settings'
                ).'">Setup->Settings->Appointments</a></h3>';
    ...
    public function getEvents($calendarId = 'primary', $timeMin = false, $timeMax = false, $maxResults = 200)
    {
        ...
        /**
         * Get all events from the past 12 months to START FROM CURRENT MONTH
         */
