...
$info_right_column .= '<br><div style="background-color: indianred;color: white;"><span style="font-weight:bold;font-size:27px;">' . $invoice_number . '</span></div><br>';
...
// The items table
$items = styleflow_get_items_table_data($invoice, 'vred', 'pdf');
