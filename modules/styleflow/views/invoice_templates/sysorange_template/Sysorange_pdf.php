...
include_once(__DIR__ . '/../../../../../application/libraries/pdf/App_pdf.php');
...
class Invoice_pdf extends App_pdf
{
    ...
    {
        $actualPath = APP_MODULES_PATH . '/styleflow/views/invoice_templates/sysorange_template/inv_template.php';
