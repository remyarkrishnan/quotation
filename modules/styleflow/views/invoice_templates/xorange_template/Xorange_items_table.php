...
class Xorange_items_table extends App_items_table_template
{
    ...
    public function items()
    {
        ...
        foreach ($this->items as $item) {
            ...
            // Open table row
            $itemHTML .= '<tr' . $this->tr_attributes($item) . ' style="background-color:#edc872;">';
    ...
    public function pdf_headings()
    {
        ...
        $tblhtml .= '<th width="5%;" align="center" style="border-bottom-color:orange;border-bottom-width:5px;border-bottom-style:solid; 5px solid orange;">' . $this->number_heading() . '</th>';
        $tblhtml .= '<th width="' . $descriptionItemWidth . '%" align="left" style="border-bottom-color:orange;border-bottom-width:5px;border-bottom-style:solid; 5px solid orange;">' . $this->item_heading() . '</th>';

        foreach ($customFieldsItems as $cf) {
            $tblhtml .= '<th width="' . $regularItemWidth . '%" align="left" style="border-bottom-color:orange;border-bottom-width:5px;border-bottom-style:solid; 5px solid orange;">' . $cf['name'] . '</th>';
        }

        $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right" style="border-bottom-color:orange;border-bottom-width:5px;border-bottom-style:solid; 5px solid orange;">' . $this->qty_heading() . '</th>';
        $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right" style="border-bottom-color:orange;border-bottom-width:5px;border-bottom-style:solid; 5px solid orange;">' . $this->rate_heading() . '</th>';

        if ($this->show_tax_per_item()) {
            $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right" style="border-bottom-color:orange;border-bottom-width:5px;border-bottom-style:solid; 5px solid orange;">' . $this->tax_heading() . '</th>';
        }

        $tblhtml .= '<th width="' . $regularItemWidth . '%" align="right" style="border-bottom-color:orange;border-bottom-width:5px;border-bottom-style:solid; 5px solid orange;">' . $this->amount_heading() . '</th>';
        $tblhtml .= '</tr>';
