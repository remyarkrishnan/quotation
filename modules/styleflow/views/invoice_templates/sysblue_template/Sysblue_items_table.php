...
class Sysblue_items_table extends App_items_table_template
{
    ...
    public function items()
    {
        ...
        foreach ($this->items as $item) {
            ...
            // Open table row
            $itemHTML .= '<tr' . $this->tr_attributes($item) . ' style="background-color:'.$color.';">';
    ...
    public function pdf_headings()
    {
        ...
        $tblhtml = '<tr height="30" bgcolor="dodgerblue" style="color:white;">';
