   ...
   <div class="content">
      <div class="panel_s">
         <div class="panel-body">
            ...
            <?php echo form_hidden('email_id',(isset($email) ? $email->id : '') ); ?>
            <?php echo form_hidden('data_design',(isset($email) ? $email->data_design : '')); ?>
            <?php echo form_hidden('data_html',(isset($email) ? $email->data_html : '')); ?>
            <?php echo form_close(); ?>
