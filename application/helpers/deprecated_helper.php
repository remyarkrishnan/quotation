...
function check_missing_language_strings($language)
{
    ...
    if (isset($keys_missing)) {
        echo '<br />--<br />Language keys missing please create <a href="https://absiltdigital.com/ABSolutions/abs-documentation.html" target="_blank">custom_lang.php</a> and add the keys listed above.';
