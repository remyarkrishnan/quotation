...
class IsCronSetupRequired extends AbstractMessage
{
    ...
    public function getMessage()
    {
        ...
        $html .= '<br />Please follow the cron <a href="https://absiltdigital.com/ABSolutions/abs-documentation.html" target="_blank">setup guide</a> in order all features to work well.';
        $html .= '<br /><br /><br />';
