 ...
 */
define('UPDATE_URL', 'https://www.absiltdigital.com/absolution_updates/index.php');

/**
 * Get latest version info
 */
define('UPDATE_INFO_URL', 'https://www.absiltdigital.com/absolution_updates/update_info.php');
