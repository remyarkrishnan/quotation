...
*
*/
define('APP_BASE_URL', 'https://32erp.hr-tracker.com/ERP/');
...
*/
define('APP_ENC_KEY', '391a48778151e0254085e138d04f9c4e');
 ...
 */
define('APP_DB_USERNAME', 'hrtracker_32erpUSER');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '21@wWEBeeERP');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'hrtracker_32erpDB');
