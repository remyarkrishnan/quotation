<tr id="tr_<?php echo $row_no; ?>" data-tr-no="<?php echo $row_no; ?>">
            ...
            <td>
                <div class="form-group" app-field-wrapper="product_name">
                    <select class="form-control" name="lead_req_unit_<?php echo $row_no; ?>" id="lead_req_unit_<?php echo $row_no; ?>">
            ...
            <div class="image-preview">
                    ...
                    <input type="file" class="file-input" accept="image/*" name="lead_req_image_<?php echo $row_no; ?>"  id="image_<?php echo $row_no; ?>" >
            ...
            <select name="lead_req_assigned_user_<?php echo $row_no; ?>" id="assigned_user_<?php echo $row_no; ?>"  class="form-control">
