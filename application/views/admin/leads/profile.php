...
<div class="lead-wrapper<?= $openEdit == true ? ' open-edit' : ''; ?>"
    ...
    <div class="row">
        ...
        <div
            ...
            <!-- Tab Content -->
            <div id="tab1" class="profile-tab-content active">
                <div class="col-md-4">
                    <?php
                    $selected = '';
                    if (isset($lead)) {
                ...
                <div class="col-md-4">
                    ...
                    // echo render_select('assigned_staff', $members, ['staffid', ['firstname', 'lastname']], 'Assigned Staff', $selected, $assigned_attrs);?>
                </div>
                <div class="clearfix"></div>
